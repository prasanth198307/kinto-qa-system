...
const RECIPIENT = '919000151199'; // Your test number
...
async function sendFreeFormMessage(
  ...
  try {
    ...
    if (response.ok) {
      ...
      console.log('\n📱 Check WhatsApp on +919000151199');
      ...
      if (data.error?.code === 131047) {
        ...
        console.log('   From +919000151199, send a WhatsApp message to your business number first.');
        ...
        console.log('   Make sure +919000151199 has WhatsApp installed.\n');
...
- KINTO Operations Team`;
  ...
  console.log('\n✅ Test complete!');
  console.log('\nNext steps:');
  console.log('1. Check WhatsApp on +919000151199');
