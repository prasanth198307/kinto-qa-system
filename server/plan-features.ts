...
export const MODULE_NAV_ITEMS: Record<string, string[]> = {
  ...
  crm: [
    ...
    "crm-surveys",
    "crm-enterprise",
    "crm/pipeline", "crm/contacts", "crm/accounts", "crm/activities",
    "crm/email-campaigns", "crm/whatsapp", "crm/reports",
  ],
  hr_payroll: [
    "hr-employees",
    "hr-attendance",
  ...
  healthcare: [
    "healthcare",
    "healthcare-enterprise", "healthcare-enterprise2",
  ...
  education: [
    "education",
    "education-enterprise", "education-enterprise2",
    "education/students", "education/admissions", "education/classes", "education/attendance",
    "education/exams", "education/fees", "education/timetable", "education/homework",
    "education/online-exams", "education/library", "education/transport", "education/hostel",
  ...
  logistics_transport: [
    ...
    "logistics/consignments", "logistics/freight", "logistics/epod", "logistics/fuel",
    "logistics/documents", "logistics/reports",
  ],
  real_estate: [
    "real-estate",
    "real-estate-enterprise",
    "real-estate/projects", "real-estate/crm", "real-estate/bookings", "real-estate/collections",
    "real-estate/brokers", "real-estate/construction", "real-estate/documents",
    "real-estate/customer-portal", "real-estate/society", "real-estate/reports",
  ],
  pos: [
    "pos",
    "retail-enterprise",
  ...
  agriculture: [
    ...
    "agriculture/farms", "agriculture/crops", "agriculture/inputs", "agriculture/harvest",
  ...
  hotel: [
    ...
    "hotel/front-desk", "hotel/reservations", "hotel/checkin", "hotel/rooms",
    "hotel/folio", "hotel/housekeeping", "hotel/rates", "hotel/corporate",
    "hotel/night-audit", "hotel/reports",
  ],
  ngo: [
    "ngo", "ngo-enterprise",
    "ngo/donors", "ngo/donations", "ngo/80g", "ngo/projects",
    "ngo/beneficiaries", "ngo/grants", "ngo/volunteers", "ngo/fcra", "ngo/reports",
  ],
  pharmacy: [
    "pharmacy", "pharmacy-enterprise",
    "pharmacy/billing", "pharmacy/drugs", "pharmacy/stock", "pharmacy/purchases",
    "pharmacy/schedule-h", "pharmacy/schedule-x", "pharmacy/licenses", "pharmacy/expiry", "pharmacy/reports",
  ],
  ecommerce: [
    "ecommerce", "ecommerce-enterprise",
    "ecommerce/dashboard", "ecommerce/orders", "ecommerce/listings", "ecommerce/shipments",
    "ecommerce/returns", "ecommerce/settlements", "ecommerce/channels", "ecommerce/reports",
  ],
  nidhi: [
    "nidhi-company",
    "nidhi/members", "nidhi/deposits", "nidhi/loans", "nidhi/emi",
    "nidhi/shares", "nidhi/gold-rates", "nidhi/interest-rates", "nidhi/daily-collection",
    "nidhi/compliance", "nidhi/reports",
  ],
  masters: [
    "masters",
    "masters/hsn-codes", "masters/sac-codes", "masters/tax-config", "masters/states-countries",
    "masters/bank-master", "masters/branches", "masters/doc-numbering", "masters/email-templates",
    "masters/sms-templates", "masters/approval-matrix", "masters/feature-flags",
    "masters/print-templates", "masters/webhooks",
  ],
    gold_erp: [
    "gold-erp",
    // Core
