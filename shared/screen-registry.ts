...
export const SCREEN_REGISTRY: ScreenDefinition[] = [
  ...
  { key: 'manufacturing_job_cards',         label: 'Manufacturing: Job Cards',             allowedActions: ['view', 'create', 'edit', 'delete'], module: 'production' },
  { key: 'manufacturing_sub_contracting',   label: 'Manufacturing: Sub-contracting',       allowedActions: ['view', 'create', 'edit', 'delete'], module: 'production' },
  { key: 'manufacturing_machine_oee',       label: 'Manufacturing: Machine OEE',           allowedActions: ['view', 'create', 'edit'],           module: 'maintenance' },
  { key: 'manufacturing_work_orders',       label: 'Manufacturing: Work Orders',           allowedActions: ['view', 'create', 'edit', 'delete'], module: 'production' },
  { key: 'manufacturing_quality',           label: 'Manufacturing: Quality Control',       allowedActions: ['view', 'create', 'edit', 'delete'], module: 'production' },
  { key: 'manufacturing_mrp',               label: 'Manufacturing: MRP Planning',          allowedActions: ['view', 'create', 'edit'],           module: 'production' },
  { key: 'manufacturing_barcode',           label: 'Manufacturing: Barcode / QR Scanner',  allowedActions: ['view', 'create', 'edit'],           module: 'production' },
  { key: 'manufacturing_pm',                label: 'Manufacturing: Preventive Maintenance', allowedActions: ['view', 'create', 'edit', 'delete'], module: 'maintenance' },
  { key: 'manufacturing_bom_versions',      label: 'Manufacturing: BOM Versions + ECN',    allowedActions: ['view', 'create', 'edit', 'delete'], module: 'production' },
  { key: 'manufacturing_supply_chain',      label: 'Manufacturing: Global Supply Chain',   allowedActions: ['view', 'create', 'edit'],           module: 'production' },
  { key: 'logistics_eway_bill',             label: 'Logistics: E-Way Bill',                allowedActions: ['view', 'create', 'edit', 'delete'], module: 'gatepasses' },
  ...
  { key: 'finance_recurring_journals', label: 'Finance: Recurring Journal Entries', allowedActions: ['view', 'create', 'edit', 'delete'], module: 'accounting' },
  { key: 'finance_consolidation',      label: 'Finance: Multi-Company Consolidation', allowedActions: ['view', 'create', 'edit', 'delete'], module: 'accounting' },
  { key: 'finance_ifrs_gaap',          label: 'Finance: IFRS / US GAAP Reporting',    allowedActions: ['view', 'create', 'edit', 'delete'], module: 'accounting' },
  { key: 'finance_zatca',              label: 'Finance: ZATCA FATOORA Portal',         allowedActions: ['view', 'create'],                  module: 'accounting' },
  { key: 'finance_gstr_direct',        label: 'Finance: GSTR Direct API Filing',       allowedActions: ['view', 'create'],                  module: 'accounting' },
  { key: 'finance_investor_reporting', label: 'Finance: PE/VC Investor Reporting Pack',allowedActions: ['view'],                            module: 'accounting' },
  ...
  { key: 'hr_reports',        label: 'HR: Reports',                                      allowedActions: ['view'],                             module: 'hr_payroll' },
  { key: 'hr_epfo_filing',    label: 'HR: EPFO / ESI Filing',                            allowedActions: ['view', 'create'],                   module: 'hr_payroll' },
  { key: 'hr_offer_letters',  label: 'HR: Offer Letters',                                allowedActions: ['view', 'create', 'edit'],            module: 'hr_payroll' },
  { key: 'hr_biometric',      label: 'HR: Biometric Attendance Devices',                 allowedActions: ['view', 'create', 'edit', 'delete'], module: 'hr_payroll' },

  // ── CRM ────────────────────────────────────────────────────────────────────
  { key: 'crm_leads',          label: 'CRM: Lead Management',       allowedActions: ['view', 'create', 'edit', 'delete'], module: 'crm' },
  { key: 'crm_pipeline',       label: 'CRM: Pipeline Management',   allowedActions: ['view', 'create', 'edit', 'delete'], module: 'crm' },
  { key: 'crm_contacts',       label: 'CRM: Contacts',              allowedActions: ['view', 'create', 'edit', 'delete'], module: 'crm' },
  { key: 'crm_accounts',       label: 'CRM: Accounts',              allowedActions: ['view', 'create', 'edit', 'delete'], module: 'crm' },
  { key: 'crm_activities',     label: 'CRM: Activities & Tasks',    allowedActions: ['view', 'create', 'edit', 'delete'], module: 'crm' },
  { key: 'crm_email_campaigns',label: 'CRM: Email Campaigns',       allowedActions: ['view', 'create', 'edit'],          module: 'crm' },
  { key: 'crm_whatsapp',       label: 'CRM: WhatsApp',              allowedActions: ['view', 'create'],                  module: 'crm' },
  { key: 'crm_reports',        label: 'CRM: Reports',               allowedActions: ['view'],                            module: 'crm' },
  { key: 'crm_telephony',      label: 'CRM: Telephony CTI',         allowedActions: ['view', 'create'],                  module: 'crm' },
  { key: 'crm_quotations',     label: 'CRM: Quotations',            allowedActions: ['view', 'create', 'edit', 'delete'], module: 'crm' },
  ...
  { key: 'healthcare_patients',     label: 'Healthcare: Patient Registration', allowedActions: ['view', 'create', 'edit', 'delete'], module: 'healthcare' },
  { key: 'healthcare_doctors',      label: 'Healthcare: Doctor Management',   allowedActions: ['view', 'create', 'edit', 'delete'], module: 'healthcare' },
  { key: 'healthcare_opd',          label: 'Healthcare: OPD & Appointments',  allowedActions: ['view', 'create', 'edit', 'delete'], module: 'healthcare' },
  { key: 'healthcare_ipd',          label: 'Healthcare: IPD & Admissions',    allowedActions: ['view', 'create', 'edit', 'delete'], module: 'healthcare' },
  { key: 'healthcare_beds',         label: 'Healthcare: Bed Management',      allowedActions: ['view', 'create', 'edit'],          module: 'healthcare' },
  { key: 'healthcare_ot',           label: 'Healthcare: OT Scheduling',       allowedActions: ['view', 'create', 'edit', 'delete'], module: 'healthcare' },
  { key: 'healthcare_lab',          label: 'Healthcare: Lab & Diagnostics',   allowedActions: ['view', 'create', 'edit'],          module: 'healthcare' },
  { key: 'healthcare_nursing',      label: 'Healthcare: Nursing & Vitals',    allowedActions: ['view', 'create', 'edit'],          module: 'healthcare' },
  { key: 'healthcare_blood_bank',   label: 'Healthcare: Blood Bank',          allowedActions: ['view', 'create', 'edit'],          module: 'healthcare' },
  { key: 'healthcare_insurance',    label: 'Healthcare: Insurance & TPA',     allowedActions: ['view', 'create', 'edit'],          module: 'healthcare' },
  { key: 'healthcare_abdm',         label: 'Healthcare: ABDM / ABHA',         allowedActions: ['view', 'create', 'edit'],          module: 'healthcare' },
  { key: 'healthcare_emr',          label: 'Healthcare: EMR',                 allowedActions: ['view', 'create', 'edit'],          module: 'healthcare' },
  { key: 'healthcare_tpa_claims',   label: 'Healthcare: TPA Claims',          allowedActions: ['view', 'create', 'edit'],          module: 'healthcare' },
  { key: 'healthcare_reports',      label: 'Healthcare: Reports',             allowedActions: ['view'],                            module: 'healthcare' },
  { key: 'hotel',                 label: 'Hotel Module',                    allowedActions: ['view', 'create', 'edit', 'delete'], module: 'hotel' },
  { key: 'hotel_rooms',           label: 'Hotel: Room Management',          allowedActions: ['view', 'create', 'edit', 'delete'], module: 'hotel' },
  { key: 'hotel_front_desk',      label: 'Hotel: Front Desk',               allowedActions: ['view', 'create', 'edit'],          module: 'hotel' },
  { key: 'hotel_reservations',    label: 'Hotel: Reservations',             allowedActions: ['view', 'create', 'edit', 'delete'], module: 'hotel' },
  { key: 'hotel_checkin',         label: 'Hotel: Check-in / Check-out',     allowedActions: ['view', 'create', 'edit'],          module: 'hotel' },
  { key: 'hotel_folio',           label: 'Hotel: Guest Folio',              allowedActions: ['view', 'create', 'edit'],          module: 'hotel' },
  { key: 'hotel_housekeeping',    label: 'Hotel: Housekeeping',             allowedActions: ['view', 'create', 'edit', 'delete'], module: 'hotel' },
  { key: 'hotel_rates',           label: 'Hotel: Rates Management',         allowedActions: ['view', 'create', 'edit', 'delete'], module: 'hotel' },
  { key: 'hotel_corporate',       label: 'Hotel: Corporate Accounts',       allowedActions: ['view', 'create', 'edit', 'delete'], module: 'hotel' },
  { key: 'hotel_night_audit',     label: 'Hotel: Night Audit',              allowedActions: ['view', 'create'],                  module: 'hotel' },
  { key: 'hotel_reports',         label: 'Hotel: Reports',                  allowedActions: ['view'],                            module: 'hotel' },
  ...
  { key: 'retail_franchise',        label: 'Retail: Franchise Management', allowedActions: ['view', 'create', 'edit'],          module: 'pos' },
  { key: 'retail_b2b_portal',       label: 'Retail: B2B Portal',           allowedActions: ['view', 'create', 'edit'],          module: 'pos' },
  { key: 'retail_store_transfers',  label: 'Retail: Store Transfers',      allowedActions: ['view', 'create', 'edit'],          module: 'pos' },
  { key: 'retail_loyalty',          label: 'Retail: Loyalty Program',      allowedActions: ['view', 'create', 'edit'],          module: 'pos' },
  { key: 'retail_omni_channel',     label: 'Retail: Omni-Channel Sync',    allowedActions: ['view', 'create', 'edit', 'delete'],module: 'pos' },
  { key: 'retail_pos_hardware',     label: 'Retail: POS Hardware',         allowedActions: ['view', 'edit'],                    module: 'pos' },
  { key: 'agriculture',         label: 'Agriculture Module',     allowedActions: ['view', 'create', 'edit', 'delete'], module: 'agriculture' },

  // ── Pharmacy ERP ───────────────────────────────────────────────────────────
  { key: 'pharmacy_billing',       label: 'Pharmacy: Billing POS',        allowedActions: ['view', 'create', 'edit', 'delete'], module: 'pharmacy' },
  { key: 'pharmacy_drugs',         label: 'Pharmacy: Drug Master',        allowedActions: ['view', 'create', 'edit', 'delete'], module: 'pharmacy' },
  { key: 'pharmacy_stock',         label: 'Pharmacy: Stock',              allowedActions: ['view', 'create', 'edit', 'delete'], module: 'pharmacy' },
  { key: 'pharmacy_purchases',     label: 'Pharmacy: Purchases',          allowedActions: ['view', 'create', 'edit', 'delete'], module: 'pharmacy' },
  { key: 'pharmacy_schedule_h',    label: 'Pharmacy: Schedule H Register',allowedActions: ['view'],                             module: 'pharmacy' },
  { key: 'pharmacy_schedule_x',    label: 'Pharmacy: Schedule X Register',allowedActions: ['view'],                             module: 'pharmacy' },
  { key: 'pharmacy_licenses',      label: 'Pharmacy: Licenses',           allowedActions: ['view', 'create', 'edit', 'delete'], module: 'pharmacy' },
  { key: 'pharmacy_expiry',        label: 'Pharmacy: Expiry & Returns',   allowedActions: ['view', 'create', 'edit'],           module: 'pharmacy' },
  { key: 'pharmacy_reports',       label: 'Pharmacy: Reports',            allowedActions: ['view'],                             module: 'pharmacy' },
  { key: 'pharmacy_prescriptions', label: 'Pharmacy: Prescriptions (Rx)', allowedActions: ['view', 'create', 'edit'],           module: 'pharmacy' },
  ...
  { key: 'gold_erp_live_rates',         label: 'Gold ERP: Live Gold Rates (MCX/IBJA)', allowedActions: ['view'],                            module: 'gold_erp' },
  { key: 'gold_erp_sebi_reporting',     label: 'Gold ERP: SEBI Bullion Reporting',     allowedActions: ['view', 'create', 'edit'],           module: 'gold_erp' },
  { key: 'gold_erp_digital_gold',       label: 'Gold ERP: Digital Gold (Purchase/Redeem)', allowedActions: ['view', 'create', 'edit'],       module: 'gold_erp' },
  ...
  // ── Restaurant ERP ────────────────────────────────────────────────────────────
  { key: 'restaurant_dashboard',      label: 'Restaurant Dashboard',       allowedActions: ['view'],                            module: 'restaurant' },
  { key: 'restaurant_pos',            label: 'Restaurant POS',             allowedActions: ['view', 'create', 'edit'],          module: 'restaurant' },
  { key: 'restaurant_kitchen',        label: 'Kitchen Display (KDS)',      allowedActions: ['view', 'edit'],                    module: 'restaurant' },
  { key: 'restaurant_tables',         label: 'Table Management',           allowedActions: ['view', 'create', 'edit', 'delete'],module: 'restaurant' },
  { key: 'restaurant_menu',           label: 'Menu Management',            allowedActions: ['view', 'create', 'edit', 'delete'],module: 'restaurant' },
  { key: 'restaurant_orders',         label: 'Orders',                     allowedActions: ['view', 'edit'],                    module: 'restaurant' },
  { key: 'restaurant_delivery',       label: 'Delivery Management',        allowedActions: ['view', 'edit'],                    module: 'restaurant' },
  { key: 'restaurant_reservations',   label: 'Reservations',               allowedActions: ['view', 'create', 'edit', 'delete'],module: 'restaurant' },
  { key: 'restaurant_shifts',         label: 'Shifts & Cash',              allowedActions: ['view', 'create', 'edit'],          module: 'restaurant' },
  { key: 'restaurant_customers',      label: 'Customers & Loyalty',        allowedActions: ['view', 'create', 'edit', 'delete'],module: 'restaurant' },
  { key: 'restaurant_inventory',      label: 'Restaurant Inventory',       allowedActions: ['view', 'create', 'edit', 'delete'],module: 'restaurant' },
  { key: 'restaurant_outlets',        label: 'Outlets & Terminals',        allowedActions: ['view', 'create', 'edit', 'delete'],module: 'restaurant' },
  { key: 'restaurant_reports',        label: 'Restaurant Reports',         allowedActions: ['view'],                            module: 'restaurant' },
  { key: 'restaurant_aggregators',    label: 'Delivery Aggregators',       allowedActions: ['view', 'create', 'edit'],          module: 'restaurant' },
  { key: 'restaurant_analytics',      label: 'Restaurant Analytics',       allowedActions: ['view'],                            module: 'restaurant' },
  { key: 'restaurant_staff',          label: 'Staff & Tips',               allowedActions: ['view', 'create', 'edit', 'delete'],module: 'restaurant' },
  { key: 'restaurant_steward',        label: 'Steward Mobile App',         allowedActions: ['view', 'create'],                  module: 'restaurant' },
  { key: 'restaurant_kiosk',          label: 'Customer Kiosk',             allowedActions: ['view'],                            module: 'restaurant' },
  { key: 'restaurant_franchise',      label: 'Franchise Management',       allowedActions: ['view', 'create', 'edit'],          module: 'restaurant' },
  { key: 'restaurant_tax_settings',   label: 'Tax & Currency Settings',    allowedActions: ['view', 'edit'],                    module: 'restaurant' },
  { key: 'restaurant_gift_cards',     label: 'Gift Cards',                 allowedActions: ['view', 'create', 'edit'],          module: 'restaurant' },
  { key: 'restaurant_central_kitchen',label: 'Central Kitchen',            allowedActions: ['view', 'create', 'edit'],          module: 'restaurant' },
  { key: 'restaurant_menu_translations',label: 'Menu Translations',        allowedActions: ['view', 'edit'],                    module: 'restaurant' },
  { key: 'restaurant_table_order',    label: 'Table QR Ordering',          allowedActions: ['view'],                            module: 'restaurant' },
  { key: 'restaurant_cds',            label: 'Customer Display Screen',    allowedActions: ['view'],                            module: 'restaurant' },
  { key: 'restaurant_campaigns',      label: 'Marketing Campaigns',        allowedActions: ['view', 'create', 'edit', 'delete'],module: 'restaurant' },
  { key: 'restaurant_recipes',        label: 'Recipe & Food Costing',      allowedActions: ['view', 'create', 'edit', 'delete'],module: 'restaurant' },
  { key: 'restaurant_payment_terminal', label: 'Payment Terminals',         allowedActions: ['view', 'create', 'edit', 'delete'],module: 'restaurant' },
  { key: 'restaurant_ondc',            label: 'ONDC Seller Integration',    allowedActions: ['view', 'create', 'edit'],           module: 'restaurant' },
  { key: 'restaurant_loyalty_expiry',  label: 'Loyalty Points Expiry Engine', allowedActions: ['view', 'create', 'edit'],         module: 'restaurant' },
  // NGO ERP
  { key: 'ngo_donors',               label: 'NGO: Donors',                 allowedActions: ['view', 'create', 'edit', 'delete'], module: 'ngo' },
  { key: 'ngo_donations',            label: 'NGO: Donations',              allowedActions: ['view', 'create', 'edit', 'delete'], module: 'ngo' },
  { key: 'ngo_80g',                  label: 'NGO: 80G Receipts',           allowedActions: ['view', 'create'],                  module: 'ngo' },
  { key: 'ngo_80g_bulk',             label: 'NGO: 80G Bulk Certificates',  allowedActions: ['view', 'create'],                  module: 'ngo' },
  { key: 'ngo_projects',             label: 'NGO: Projects',               allowedActions: ['view', 'create', 'edit', 'delete'], module: 'ngo' },
  { key: 'ngo_beneficiaries',        label: 'NGO: Beneficiaries',          allowedActions: ['view', 'create', 'edit', 'delete'], module: 'ngo' },
  { key: 'ngo_grants',               label: 'NGO: Grants',                 allowedActions: ['view', 'create', 'edit', 'delete'], module: 'ngo' },
  { key: 'ngo_volunteers',           label: 'NGO: Volunteers',             allowedActions: ['view', 'create', 'edit', 'delete'], module: 'ngo' },
  { key: 'ngo_fcra',                 label: 'NGO: FCRA Compliance',        allowedActions: ['view', 'create', 'edit'],          module: 'ngo' },
  { key: 'ngo_csr',                  label: 'NGO: CSR Module',             allowedActions: ['view', 'create', 'edit'],          module: 'ngo' },
  { key: 'ngo_funds',                label: 'NGO: Fund Accounting',        allowedActions: ['view', 'create'],                  module: 'ngo' },
  { key: 'ngo_donor_admin',          label: 'NGO: Donor Portal Admin',     allowedActions: ['view', 'create'],                  module: 'ngo' },
  { key: 'ngo_reports',              label: 'NGO: Reports',                allowedActions: ['view'],                            module: 'ngo' },
  // Nidhi Company ERP
  { key: 'nidhi_members',            label: 'Nidhi: Members',              allowedActions: ['view', 'create', 'edit', 'delete'], module: 'nidhi' },
  { key: 'nidhi_deposits',           label: 'Nidhi: Deposits',             allowedActions: ['view', 'create', 'edit'],          module: 'nidhi' },
  { key: 'nidhi_loans',              label: 'Nidhi: Loans',                allowedActions: ['view', 'create', 'edit'],          module: 'nidhi' },
  { key: 'nidhi_emi',                label: 'Nidhi: EMI Collection',       allowedActions: ['view', 'create'],                  module: 'nidhi' },
  { key: 'nidhi_shares',             label: 'Nidhi: Share Management',     allowedActions: ['view', 'create', 'edit'],          module: 'nidhi' },
  { key: 'nidhi_gold_rates',         label: 'Nidhi: Gold Rates',           allowedActions: ['view', 'create', 'edit'],          module: 'nidhi' },
  { key: 'nidhi_interest_rates',     label: 'Nidhi: Interest Rates',       allowedActions: ['view', 'create', 'edit', 'delete'],module: 'nidhi' },
  { key: 'nidhi_daily_collection',   label: 'Nidhi: Daily Collection',     allowedActions: ['view', 'create'],                  module: 'nidhi' },
  { key: 'nidhi_compliance',         label: 'Nidhi: Compliance (NDH)',     allowedActions: ['view', 'create'],                  module: 'nidhi' },
  { key: 'nidhi_reports',            label: 'Nidhi: Reports',              allowedActions: ['view'],                            module: 'nidhi' },
  { key: 'nidhi_loan_sanction',      label: 'Nidhi: Loan Sanction',        allowedActions: ['view', 'create', 'edit'],          module: 'nidhi' },
  { key: 'nidhi_pdc_tracking',       label: 'Nidhi: PDC Tracking',         allowedActions: ['view', 'create', 'edit'],          module: 'nidhi' },
  { key: 'nidhi_rbi_returns',        label: 'Nidhi: RBI NDH Returns',      allowedActions: ['view', 'create'],                  module: 'nidhi' },
  { key: 'nidhi_member_passbook',    label: 'Nidhi: Member Passbook',      allowedActions: ['view'],                            module: 'nidhi' },
  { key: 'nidhi_mobile_collection',  label: 'Nidhi: Mobile Collection',    allowedActions: ['view', 'create'],                  module: 'nidhi' },
  { key: 'swachdesk',                 label: 'SwachDesk - Tickets',        allowedActions: ['view', 'create', 'edit', 'delete'],module: 'swachdesk' },
  { key: 'swachdesk_reports',         label: 'SwachDesk - Reports',        allowedActions: ['view'],                            module: 'swachdesk' },
  { key: 'swachforms',                label: 'SwachForms - Forms',         allowedActions: ['view', 'create', 'edit', 'delete'],module: 'swachforms' },
  { key: 'swachforms_builder',        label: 'SwachForms - Builder',       allowedActions: ['view', 'create', 'edit'],          module: 'swachforms' },
  { key: 'swachforms_submissions',    label: 'SwachForms - Submissions',   allowedActions: ['view', 'edit'],                    module: 'swachforms' },
  { key: 'swachsign',                 label: 'SwachSign - eSigning',       allowedActions: ['view', 'create', 'edit'],          module: 'swachsign' },
  { key: 'swachmeet',                 label: 'SwachMeet - Video Meetings', allowedActions: ['view', 'create'],                  module: 'swachmeet' },
  { key: 'swachsocial',               label: 'SwachSocial - Social Media', allowedActions: ['view', 'create', 'edit', 'delete'],module: 'swachsocial' },
];
