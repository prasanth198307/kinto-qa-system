...
import { SCREEN_REGISTRY } from "@shared/screen-registry";
...
// AVAILABLE_SCREENS is sourced from shared/screen-registry.ts — the single source of truth.
// To add a new screen, add it there. Do NOT add entries here directly.
const AVAILABLE_SCREENS = SCREEN_REGISTRY;
