...
function BookingsTab() {
  ...
  const { data: schedules = [] } = useQuery<any[]>({ queryKey: ["/api/real-estate/payment-schedules", showPayments?.id], enabled: !!showPayments, queryFn: () => fetch(`/api/real-estate/payment-schedules/${showPayments.id}`, { credentials: "include" }).then(r => r.json()) });
