...
import {
  ...
  Hotel, Pill, TreePine, Landmark, UtensilsCrossed,
} from "lucide-react";
...
const INDUSTRIES = [
  ...
  },
  {
    ...
    subtitle: "Hotels, resorts, guesthouses, service apartments",
    color: "from-sky-50 to-sky-100 border-sky-200",
    iconColor: "text-sky-600 bg-sky-100",
    challenges: [
      "Managing room availability and reservations across OTA channels",
      "Posting F&B and room service charges to guest folios",
      "Housekeeping scheduling and room status tracking",
      "GST-compliant invoicing for accommodation and F&B",
    ],
    how: "SwachERP's Hotel ERP handles the full guest journey — from online reservation to check-out. Room assignments, folio management, F&B POS with room posting, banquet bookings, and GST invoicing all in one system.",
    modules: ["Room Inventory", "Front Office PMS", "F&B POS", "Housekeeping", "Banquet Management", "GST Invoicing"],
    stat: { value: "30%", label: "increase in room revenue with real-time channel availability" },
  },
  {
    id: "restaurant",
    icon: UtensilsCrossed,
    name: "Restaurant & F&B",
    subtitle: "Dine-in restaurants, QSRs, cloud kitchens, cafes, bars",
    color: "from-orange-50 to-orange-100 border-orange-200",
    iconColor: "text-orange-600 bg-orange-100",
    challenges: [
      "Managing table orders and KOT routing to the kitchen",
      "Split billing, partial payments, and cashier reconciliation",
      "Real-time inventory depletion per recipe and wastage tracking",
      "GST billing with dine-in vs takeaway tax differentiation",
    ],
    how: "The Restaurant ERP covers table management, steward ordering, KOT routing, POS billing, shift Z-reports, and raw material consumption — all linked to accounting automatically.",
    modules: ["Table Management", "KOT & POS", "Menu & Recipe Costing", "Shift Z-Report", "Customer Loyalty", "GST Invoicing"],
    stat: { value: "2×", label: "faster table turns with digital KOT vs paper ordering" },
  },
  {
    id: "pharmacy",
    icon: Pill,
    name: "Pharmacy & Drug Stores",
    subtitle: "Retail pharmacies, hospital pharmacies, drug distribution",
    color: "from-lime-50 to-lime-100 border-lime-200",
    iconColor: "text-lime-700 bg-lime-100",
    challenges: [
      "FEFO (First Expiry First Out) stock management to avoid expiry losses",
      "Narcotics and Schedule H / H1 drug register maintenance",
      "Prescription tracking and compliance record-keeping",
      "Supplier return and expiry claim management",
    ],
    how: "SwachERP's Pharmacy module enforces FEFO billing, maintains the narcotics register automatically on each sale, links prescriptions to bills, and manages supplier expiry returns — all GST-compliant.",
    modules: ["FEFO Billing", "Narcotics Register", "Prescription Management", "Supplier Returns", "Expiry Alerts", "GST Invoicing"],
    stat: { value: "80%", label: "reduction in expiry write-offs with FEFO enforcement" },
  },
  {
    id: "ngo",
    icon: TreePine,
    name: "NGO / Trusts & Foundations",
    subtitle: "Charitable trusts, Section 8 companies, CSR-funded organisations",
    color: "from-emerald-50 to-emerald-100 border-emerald-200",
    iconColor: "text-emerald-600 bg-emerald-100",
    challenges: [
      "Issuing 80G certificates in bulk to hundreds of donors",
      "Tracking FCRA-regulated foreign contributions separately",
      "Project-wise fund utilisation reporting for board and donors",
      "CSR compliance documentation for corporate donors",
    ],
    how: "SwachERP's NGO ERP handles donor management, 80G PDF bulk generation, FCRA fund accounting, project-wise spend tracking, and CSR reports — keeping your charity audit-ready at all times.",
    modules: ["Donor Management", "80G Certificates", "FCRA Fund Accounting", "Project Spend Tracking", "CSR Compliance", "Accounting"],
    stat: { value: "100%", label: "80G certificates generated and emailed within minutes of donation" },
  },
  {
    id: "nidhi",
    icon: Landmark,
    name: "Nidhi Company",
    subtitle: "Nidhi companies, mutual benefit societies, credit co-operatives",
    color: "from-yellow-50 to-yellow-100 border-yellow-200",
    iconColor: "text-yellow-700 bg-yellow-100",
    challenges: [
      "Managing thousands of member FD/RD accounts with maturity alerts",
      "Loan sanction, disbursement, and EMI collection workflow",
      "PDC (post-dated cheque) tracking and bounce management",
      "Generating RBI NDH quarterly returns without errors",
    ],
    how: "SwachERP's Nidhi ERP manages the full member lifecycle — savings, FD/RD, loans, and EMI collection. PDC alerts prevent missed cheques and the built-in NDH return generator keeps you RBI-compliant.",
    modules: ["Member Management", "FD / RD Management", "Loan Workflow", "EMI Collection", "PDC Tracking", "RBI NDH Returns"],
    stat: { value: "Zero", label: "manual RBI return errors with automated NDH filing support" },
  },
  {
    id: "services",
    icon: Briefcase,
