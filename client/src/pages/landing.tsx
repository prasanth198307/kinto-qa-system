              ...
              <div key={group.group} className="p-4">
                ...
                <div className="space-y-0.5">
                  {group.items.map(item => (
                    <a key={item.label} href="#modules" onClick={() => setOpen(false)} className="flex items-start gap-2.5 px-2 py-2 rounded-lg hover-elevate cursor-pointer group no-underline">
            ...
            <div className="p-4">
              ...
              <div className="grid grid-cols-2 gap-1">
                {NAV_SOLUTIONS_BY_INDUSTRY.map(item => (
                  <a key={item.label} href="#solutions" onClick={() => setOpen(false)} className="px-2 py-1.5 rounded-lg hover-elevate no-underline">
