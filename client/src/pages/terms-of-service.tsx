    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-10 space-y-8">
        ...
        <p className="text-muted-foreground leading-relaxed">
          ...
          provided by MicroGrid ("<strong>Company</strong>", "we", "us", or "our"). By accessing or
        ...
        {[
          ...
          },
          {
            ...
            body: `The Service, including its design, software, logos, and content, is owned by MicroGrid and is protected by copyright, trademark, and other intellectual property laws. Nothing in these Terms grants you any right to use our trademarks, logos, or other proprietary information without our prior written consent.`,
          },
          {
          ...
          },
          {
            ...
            body: `To the maximum extent permitted by law, MicroGrid shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including loss of profits, data, or goodwill, arising from your use of or inability to use the Service. Our total liability for any claim shall not exceed the amount you paid to us in the three months preceding the claim.`,
          },
          {
            title: "11. Indemnification",
            body: `You agree to indemnify and hold harmless MicroGrid and its officers, directors, employees, and agents from any claims, liabilities, damages, and expenses (including reasonable legal fees) arising from your use of the Service or violation of these Terms.`,
          },
          {
        ...
        <div className="border-t pt-6 text-xs text-muted-foreground">
          <p>© {year} MicroGrid. All rights reserved.</p>
        </div>
      </main>
    </div>
  );
