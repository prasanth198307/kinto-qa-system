...
const CompanySelectPage = lazy(() => import("@/pages/company-select"));
const RegisterCompanyPage = lazy(() => import("@/pages/register-company"));
...
const MachineCard = lazy(() => import("@/components/MachineCard"));
const ChecklistHistoryTable = lazy(() => import("@/components/ChecklistHistoryTable"));
...
const AdminMachineConfig = lazy(() => import("@/components/AdminMachineConfig"));
const AdminChecklistBuilder = lazy(() => import("@/components/AdminChecklistBuilder"));
const AdminSparePartsManagement = lazy(() => import("@/components/AdminSparePartsManagement"));
const SparePartsStockView = lazy(() => import("@/components/SparePartsStockView"));
const AdminMachineTypeConfig = lazy(() => import("@/components/AdminMachineTypeConfig"));
const AdminPMTaskListTemplates = lazy(() => import("@/components/AdminPMTaskListTemplates"));
const SchedulePMDialog = lazy(() => import("@/components/SchedulePMDialog"));
const PurchaseOrderManagement = lazy(() => import("@/components/PurchaseOrderManagement"));
const PMHistoryView = lazy(() => import("@/components/PMHistoryView"));
const PMExecutionDialog = lazy(() => import("@/components/PMExecutionDialog"));
const InventoryManagement = lazy(() => import("@/pages/inventory-management"));
const RawMaterialTypeMaster = lazy(() => import("@/pages/raw-material-type-master"));
const ProductionManagement = lazy(() => import("@/pages/production-management"));
const ProductionEntries = lazy(() => import("@/pages/production-entries"));
...
const CustomerOutstandingReport = lazy(() => import("@/pages/customer-outstanding-report"));
...
const VendorTypes = lazy(() => import("@/pages/vendor-types"));
...
const CancelledInvoices = lazy(() => import("@/pages/cancelled-invoices"));
const WriteOffReport = lazy(() => import("@/pages/write-off-report"));
const InventorySummaryDashboard = lazy(() => import("@/components/InventorySummaryDashboard"));
const TodayProductionStats = lazy(() => import("@/components/TodayProductionStats"));
const RolePermissionsView = lazy(() => import("@/components/RolePermissionsView"));
const RoleManagement = lazy(() => import("@/components/RoleManagement"));
const ManagerChecklistAssignment = lazy(() => import("@/components/ManagerChecklistAssignment").then(m => ({ default: m.ManagerChecklistAssignment })));
const PendingPaymentsDashboard = lazy(() => import("@/components/PendingPaymentsDashboard"));
...
const SwachDeskReportsPage = lazy(() => import("@/pages/swachdesk/reports"));
const KnowledgeBasePage = lazy(() => import("@/pages/swachdesk/knowledge-base"));
const RoutingRulesPage = lazy(() => import("@/pages/swachdesk/routing-rules"));
const LiveChatPage = lazy(() => import("@/pages/swachdesk/live-chat"));
const SwachFormsPage = lazy(() => import("@/pages/swachforms/index"));
const SwachFormsBuilderPage = lazy(() => import("@/pages/swachforms/builder"));
const SwachFormsSubmissionsPage = lazy(() => import("@/pages/swachforms/submissions"));
const SwachFormsPreviewPage = lazy(() => import("@/pages/swachforms/preview"));
...
const SalesOfficersPage = lazy(() => import("@/pages/sales-officers"));
const VendorAnalytics = lazy(() => import("@/pages/vendor-analytics"));
const SpareParts = lazy(() => import("@/pages/spare-parts"));
const ScrapManagement = lazy(() => import("@/pages/scrap-management"));
const PurchaseReturns = lazy(() => import("@/pages/purchase-returns"));
const TDSManagement = lazy(() => import("@/pages/tds-management"));
const ReviewerDashboardPage = lazy(() => import("@/pages/ReviewerDashboard"));
...
const DispatchTracking = lazy(() => import("@/pages/dispatch-tracking"));
...
const MonthlyExpensesPage = lazy(() => import("@/pages/monthly-expenses"));
const CashRegisterPage = lazy(() => import("@/pages/cash-register"));
const CashRegisterReport = lazy(() => import("@/pages/cash-register-report"));
const CashRegisterVoucherPrint = lazy(() => import("@/pages/cash-register-voucher-print"));
const VendorHistory = lazy(() => import("@/pages/vendor-history"));
const VendorHistoryDetail = lazy(() => import("@/pages/vendor-history-detail"));
const VendorGroupDetail = lazy(() => import("@/pages/vendor-group-detail"));
const VendorDebitNotes = lazy(() => import("@/pages/vendor-debit-notes"));
const CustomerAdvances = lazy(() => import("@/pages/customer-advances"));
const MISDashboard = lazy(() => import("@/pages/mis-dashboard"));
const MISProduction = lazy(() => import("@/pages/mis-production"));
const MISInventory = lazy(() => import("@/pages/mis-inventory"));
const MISSales = lazy(() => import("@/pages/mis-sales"));
const MISDelivery = lazy(() => import("@/pages/mis-delivery"));
const MISCash = lazy(() => import("@/pages/mis-cash"));
const MISFinancial = lazy(() => import("@/pages/mis-financial"));
const MISManufacturing = lazy(() => import("@/pages/mis-manufacturing"));
const DispatchMasters = lazy(() => import("@/pages/dispatch-masters"));
const PrintInvoicePage = lazy(() => import("@/pages/PrintInvoicePage"));
const PrintGatepassPage = lazy(() => import("@/pages/PrintGatepassPage"));
const PrintCreditNotePage = lazy(() => import("@/pages/PrintCreditNotePage"));
const PrintDebitNotePage = lazy(() => import("@/pages/PrintDebitNotePage"));
const PrintInvoiceGatepassPage = lazy(() => import("@/pages/PrintInvoiceGatepassPage"));
const RawMaterialDetail = lazy(() => import("@/pages/raw-material-detail"));
const RawMaterialTypeDetail = lazy(() => import("@/pages/raw-material-type-detail"));
const ProductDetail = lazy(() => import("@/pages/product-detail"));
const FinishedGoodDetail = lazy(() => import("@/pages/finished-good-detail"));
const ChartOfAccountsPage = lazy(() => import("@/pages/chart-of-accounts"));
const AccountSubtypesPage = lazy(() => import("@/pages/account-subtypes"));
const JournalEntriesPage = lazy(() => import("@/pages/journal-entries"));
const JournalEntryDetailPage = lazy(() => import("@/pages/journal-entry-detail"));
const ManualJournalEntryPage = lazy(() => import("@/pages/manual-journal-entry"));
...
const LedgerViewPage = lazy(() => import("@/pages/ledger-view"));
const DayBookPage = lazy(() => import("@/pages/day-book"));
const AgingReportPage = lazy(() => import("@/pages/aging-report"));
const CashFlowStatementPage = lazy(() => import("@/pages/cash-flow-statement"));
const GroupSummaryPage = lazy(() => import("@/pages/group-summary"));
const BudgetVariancePage = lazy(() => import("@/pages/budget-variance"));
const AdminToolsPage = lazy(() => import("@/pages/admin-tools"));
const TenantSettings = lazy(() => import("@/pages/tenant-settings"));
const HRMastersPage = lazy(() => import("@/pages/hr-masters"));
const HREmployeesPage = lazy(() => import("@/pages/hr-employees"));
const HRAttendancePage = lazy(() => import("@/pages/hr-attendance"));
const HRLeavesPage = lazy(() => import("@/pages/hr-leaves"));
const HRPayrollPage = lazy(() => import("@/pages/hr-payroll"));
const HRReportsPage = lazy(() => import("@/pages/hr-reports"));
const HRExitManagementPage = lazy(() => import("@/pages/hr-exit-management"));
const HRLoansPage = lazy(() => import("@/pages/hr-loans"));
const HRTdsDeclarationsPage = lazy(() => import("@/pages/hr-tds-declarations"));
const HRRecruitmentPage = lazy(() => import("@/pages/hr-recruitment"));
const HRPayslipPage = lazy(() => import("@/pages/hr-payslip"));
const PricingPage = lazy(() => import("@/pages/pricing"));
const EssLogin = lazy(() => import("@/pages/ess-login"));
const EssPortal = lazy(() => import("@/pages/ess-portal"));
const HRExpenseClaimsPage = lazy(() => import("@/pages/hr-expense-claims"));
const HROnboardingPage = lazy(() => import("@/pages/hr-onboarding"));
const HRLettersPage = lazy(() => import("@/pages/hr-letters"));
const HRSupportDeskPage = lazy(() => import("@/pages/hr-support-desk"));
...
const InventoryBulkImportPage = lazy(() => import("@/pages/inventory-bulk-import"));
const InventoryGrnScanPage = lazy(() => import("@/pages/inventory-grn-scan"));
const InventoryStockAdjustmentsPage = lazy(() => import("@/pages/inventory-stock-adjustments"));
...
const PerformanceAppraisalPage = lazy(() => import("@/pages/performance-appraisal"));
const CurrencyManagementPage = lazy(() => import("@/pages/currency-management"));
const TaxEnginePage = lazy(() => import("@/pages/tax-engine"));
const CostCentresPage = lazy(() => import("@/pages/cost-centres"));
const PurchaseRequisitionsPage = lazy(() => import("@/pages/purchase-requisitions"));
const ApprovalWorkflowsPage = lazy(() => import("@/pages/approval-workflows"));
const GoodsReceiptNotesPage = lazy(() => import("@/pages/goods-receipt-notes"));
const PriceListsPage = lazy(() => import("@/pages/price-lists"));
const GSTRReportsPage = lazy(() => import("@/pages/gstr-reports"));
...
const SuperAdminSetupWizard = lazy(() => import("@/pages/super-admin-setup-wizard"));
...
const CRMPipelinePage = lazy(() => import("@/pages/crm"));
const EcommercePage = lazy(() => import("@/pages/ecommerce"));
const NGOPage = lazy(() => import("@/pages/ngo"));
const PharmacyPage = lazy(() => import("@/pages/pharmacy"));
const NidhiPage = lazy(() => import("@/pages/nidhi"));
const FinanceErpPage = lazy(() => import("@/pages/finance-erp"));
...
const GoldErpPage = lazy(() => import("@/pages/gold-erp"));
...
const PeriodClosePage = lazy(() => import("@/pages/period-close"));
const RestaurantEnterprisePage = lazy(() => import("@/pages/restaurant-enterprise"));
const HotelEnterprisePage = lazy(() => import("@/pages/hotel-enterprise"));
const HealthcareEnterprisePage = lazy(() => import("@/pages/healthcare-enterprise"));
const EducationEnterprisePage = lazy(() => import("@/pages/education-enterprise"));
const RealEstateEnterprisePage = lazy(() => import("@/pages/real-estate-enterprise"));
const MastersPage = lazy(() => import("@/pages/masters"));
const RetailEnterprisePage = lazy(() => import("@/pages/retail-enterprise"));
const PharmacyEnterprisePage = lazy(() => import("@/pages/pharmacy-enterprise"));
const LogisticsEnterprisePage = lazy(() => import("@/pages/logistics-enterprise"));
const CRMEnterprisePage = lazy(() => import("@/pages/crm-enterprise"));
const NGOEnterprisePage = lazy(() => import("@/pages/ngo-enterprise"));
const AgricultureEnterprisePage = lazy(() => import("@/pages/agriculture-enterprise"));
const EcommerceEnterprisePage = lazy(() => import("@/pages/ecommerce-enterprise"));
const HealthcareEnterprise2Page = lazy(() => import("@/pages/healthcare-enterprise2"));
const EducationEnterprise2Page = lazy(() => import("@/pages/education-enterprise2"));
const RestaurantPOSPage = lazy(() => import("@/pages/restaurant-pos"));
const RestaurantKitchenPage = lazy(() => import("@/pages/restaurant-kitchen"));
const RestaurantTablesPage = lazy(() => import("@/pages/restaurant-tables"));
const RestaurantMenuPage = lazy(() => import("@/pages/restaurant-menu"));
const RestaurantOrdersPage = lazy(() => import("@/pages/restaurant-orders"));
const RestaurantDeliveryPage = lazy(() => import("@/pages/restaurant-delivery"));
const RestaurantReservationsPage = lazy(() => import("@/pages/restaurant-reservations"));
const RestaurantShiftsPage = lazy(() => import("@/pages/restaurant-shifts"));
const RestaurantCustomersPage = lazy(() => import("@/pages/restaurant-customers"));
const RestaurantInventoryPage = lazy(() => import("@/pages/restaurant-inventory"));
const RestaurantOutletsPage = lazy(() => import("@/pages/restaurant-outlets"));
const RestaurantReportsPage = lazy(() => import("@/pages/restaurant-reports"));
const RestaurantStewardPage = lazy(() => import("@/pages/restaurant-steward"));
const RestaurantKioskPage = lazy(() => import("@/pages/restaurant-kiosk"));
const RestaurantAggregatorsPage = lazy(() => import("@/pages/restaurant-aggregators"));
const RestaurantAnalyticsPage = lazy(() => import("@/pages/restaurant-analytics"));
const RestaurantStaffPage = lazy(() => import("@/pages/restaurant-staff"));
const RestaurantFranchisePage = lazy(() => import("@/pages/restaurant-franchise"));
const RestaurantTaxSettingsPage = lazy(() => import("@/pages/restaurant-tax-settings"));
const RestaurantGiftCardsPage = lazy(() => import("@/pages/restaurant-gift-cards"));
const RestaurantCentralKitchenPage = lazy(() => import("@/pages/restaurant-central-kitchen"));
const RestaurantMenuTranslationsPage = lazy(() => import("@/pages/restaurant-menu-translations"));
const RestaurantTableOrderPage = lazy(() => import("@/pages/restaurant-table-order"));
const RestaurantCDSPage = lazy(() => import("@/pages/restaurant-cds"));
const RestaurantCampaignsPage = lazy(() => import("@/pages/restaurant-campaigns"));
const RestaurantRecipesPage = lazy(() => import("@/pages/restaurant-recipes"));
const RestaurantOnlineOrderPage = lazy(() => import("@/pages/restaurant-online-order"));
const RestaurantPaymentTerminalPage = lazy(() => import("@/pages/restaurant-payment-terminal"));
const HotelFrontDeskPage = lazy(() => import("@/pages/hotel/front-desk"));
const HotelReservationsPage = lazy(() => import("@/pages/hotel/reservations"));
const HotelCheckinPage = lazy(() => import("@/pages/hotel/checkin"));
const HotelRoomsPage = lazy(() => import("@/pages/hotel/rooms"));
const HotelFolioPage = lazy(() => import("@/pages/hotel/folio"));
const HotelHousekeepingPage = lazy(() => import("@/pages/hotel/housekeeping"));
const HotelRatesPage = lazy(() => import("@/pages/hotel/rates"));
const HotelCorporatePage = lazy(() => import("@/pages/hotel/corporate"));
const HotelNightAuditPage = lazy(() => import("@/pages/hotel/night-audit"));
const HotelReportsPage = lazy(() => import("@/pages/hotel/reports"));
const HotelChannelManagerPage = lazy(() => import("@/pages/hotel/channel-manager"));
const HotelRevenueManagementPage = lazy(() => import("@/pages/hotel/revenue-management"));
const HotelBanquetPage = lazy(() => import("@/pages/hotel/banquet"));
const OndcIntegrationPage = lazy(() => import("@/pages/restaurant/ondc-integration"));
const LoyaltyExpiryPage = lazy(() => import("@/pages/restaurant/loyalty-expiry"));
const MultiCompanyPage = lazy(() => import("@/pages/multi-company"));
const GSTRFilingPage = lazy(() => import("@/pages/gstr-filing"));
const HealthcarePatientsPage = lazy(() => import("@/pages/healthcare/patients"));
const HealthcareOPDPage = lazy(() => import("@/pages/healthcare/opd"));
const HealthcareIPDPage = lazy(() => import("@/pages/healthcare/ipd"));
const HealthcareBedsPage = lazy(() => import("@/pages/healthcare/beds"));
const HealthcareOTPage = lazy(() => import("@/pages/healthcare/ot"));
const HealthcareLabPage = lazy(() => import("@/pages/healthcare/lab"));
const HealthcareNursingPage = lazy(() => import("@/pages/healthcare/nursing"));
const HealthcareInsurancePage = lazy(() => import("@/pages/healthcare/insurance"));
const HealthcareDoctorsPage = lazy(() => import("@/pages/healthcare/doctors"));
const HealthcareBloodBankPage = lazy(() => import("@/pages/healthcare/blood-bank"));
const HealthcareReportsPage = lazy(() => import("@/pages/healthcare/reports"));
const HealthcareABDMPage = lazy(() => import("@/pages/healthcare/abdm"));
const HealthcareEMRPage = lazy(() => import("@/pages/healthcare/emr"));
const HealthcareTPAClaimsPage = lazy(() => import("@/pages/healthcare/tpa-claims"));
const EducationStudentsPage = lazy(() => import("@/pages/education/students"));
const EducationAdmissionsPage = lazy(() => import("@/pages/education/admissions"));
const EducationClassesPage = lazy(() => import("@/pages/education/classes"));
const EducationAttendancePage = lazy(() => import("@/pages/education/attendance"));
const EducationExamsPage = lazy(() => import("@/pages/education/exams"));
const EducationFeesPage = lazy(() => import("@/pages/education/fees"));
const EducationTimetablePage = lazy(() => import("@/pages/education/timetable"));
const EducationHomeworkPage = lazy(() => import("@/pages/education/homework"));
const EducationOnlineExamsPage = lazy(() => import("@/pages/education/online-exams"));
const EducationLibraryPage = lazy(() => import("@/pages/education/library"));
const EducationTransportPage = lazy(() => import("@/pages/education/transport"));
const EducationHostelPage = lazy(() => import("@/pages/education/hostel"));
const EducationParentPortalPage = lazy(() => import("@/pages/education/parent-portal"));
const EducationReportsPage = lazy(() => import("@/pages/education/reports"));
const RealEstateProjectsPage = lazy(() => import("@/pages/real-estate/projects"));
const RealEstateCRMPage = lazy(() => import("@/pages/real-estate/crm"));
const RealEstateBookingsPage = lazy(() => import("@/pages/real-estate/bookings"));
const RealEstateCollectionsPage = lazy(() => import("@/pages/real-estate/collections"));
const RealEstateBrokersPage = lazy(() => import("@/pages/real-estate/brokers"));
const RealEstateConstructionPage = lazy(() => import("@/pages/real-estate/construction"));
const RealEstateDocumentsPage = lazy(() => import("@/pages/real-estate/documents"));
const RealEstateCustomerPortalPage = lazy(() => import("@/pages/real-estate/customer-portal"));
const RealEstateSocietyPage = lazy(() => import("@/pages/real-estate/society"));
const RealEstateReportsPage = lazy(() => import("@/pages/real-estate/reports"));
const RealEstateBankLoansPage = lazy(() => import("@/pages/real-estate/bank-loans"));
const RealEstateSubcontractorsPage = lazy(() => import("@/pages/real-estate/subcontractors"));
const LogisticsFleetPage = lazy(() => import("@/pages/logistics/fleet"));
const LogisticsDriversPage = lazy(() => import("@/pages/logistics/drivers"));
const LogisticsTripsPage = lazy(() => import("@/pages/logistics/trips"));
const LogisticsGPSPage = lazy(() => import("@/pages/logistics/gps"));
const LogisticsConsignmentsPage = lazy(() => import("@/pages/logistics/consignments"));
const LogisticsFreightPage = lazy(() => import("@/pages/logistics/freight"));
const LogisticsEPODPage = lazy(() => import("@/pages/logistics/epod"));
const LogisticsFuelPage = lazy(() => import("@/pages/logistics/fuel"));
const LogisticsDocumentsPage = lazy(() => import("@/pages/logistics/documents"));
const LogisticsReportsPage = lazy(() => import("@/pages/logistics/reports"));
const AgricultureFarmsPage = lazy(() => import("@/pages/agriculture/farms"));
const AgricultureCropsPage = lazy(() => import("@/pages/agriculture/crops"));
const AgricultureInputsPage = lazy(() => import("@/pages/agriculture/inputs"));
const AgricultureHarvestPage = lazy(() => import("@/pages/agriculture/harvest"));
const AgricultureWeatherPage = lazy(() => import("@/pages/agriculture/weather"));
const AgricultureSchemesPage = lazy(() => import("@/pages/agriculture/schemes"));
const AgricultureFPOPage = lazy(() => import("@/pages/agriculture/fpo"));
const AgricultureMarketPage = lazy(() => import("@/pages/agriculture/market"));
const AgricultureReportsPage = lazy(() => import("@/pages/agriculture/reports"));
const NGODonorsPage = lazy(() => import("@/pages/ngo/donors"));
const NGODonationsPage = lazy(() => import("@/pages/ngo/donations"));
const NGO80GPage = lazy(() => import("@/pages/ngo/80g"));
const NGOProjectsPage = lazy(() => import("@/pages/ngo/projects"));
const NGOBeneficiariesPage = lazy(() => import("@/pages/ngo/beneficiaries"));
const NGOGrantsPage = lazy(() => import("@/pages/ngo/grants"));
const NGOVolunteersPage = lazy(() => import("@/pages/ngo/volunteers"));
const NGOFCRAPage = lazy(() => import("@/pages/ngo/fcra"));
const NGOReportsPage = lazy(() => import("@/pages/ngo/reports"));
const NGO80GBulkPage = lazy(() => import("@/pages/ngo/80g-bulk"));
const NGOCSRPage = lazy(() => import("@/pages/ngo/csr"));
const NGOFundsPage = lazy(() => import("@/pages/ngo/funds"));
const DonatePublicPage = lazy(() => import("@/pages/donate-public"));
const PublicDashboardPage = lazy(() => import("@/pages/analytics/public-dashboard"));
const PharmacyBillingPage = lazy(() => import("@/pages/pharmacy/billing"));
const PharmacyDrugsPage = lazy(() => import("@/pages/pharmacy/drugs"));
const PharmacyStockPage = lazy(() => import("@/pages/pharmacy/stock"));
const PharmacyPurchasesPage = lazy(() => import("@/pages/pharmacy/purchases"));
const PharmacyScheduleHPage = lazy(() => import("@/pages/pharmacy/schedule-h"));
const PharmacyScheduleXPage = lazy(() => import("@/pages/pharmacy/schedule-x"));
const PharmacyLicensesPage = lazy(() => import("@/pages/pharmacy/licenses"));
const PharmacyExpiryPage = lazy(() => import("@/pages/pharmacy/expiry"));
const PharmacyReportsPage = lazy(() => import("@/pages/pharmacy/reports"));
const PharmacyNarcoticsRegisterPage = lazy(() => import("@/pages/pharmacy/narcotics-register"));
const PharmacyEInvoicePage = lazy(() => import("@/pages/pharmacy/e-invoice"));
const PharmacyPrescriptionsPage = lazy(() => import("@/pages/pharmacy/prescriptions"));
const CRMPipelineSubPage = lazy(() => import("@/pages/crm/pipeline"));
...
const CRMEmailCampaignsPage = lazy(() => import("@/pages/crm/email-campaigns"));
const CRMWhatsAppPage = lazy(() => import("@/pages/crm/whatsapp"));
const CRMReportsPage = lazy(() => import("@/pages/crm/reports"));
const CRMTelephonyPage = lazy(() => import("@/pages/crm/telephony"));
const CRMQuotationsPage = lazy(() => import("@/pages/crm/quotations"));
const NidhiMembersPage = lazy(() => import("@/pages/nidhi/members"));
const NidhiDepositsPage = lazy(() => import("@/pages/nidhi/deposits"));
const NidhiLoansPage = lazy(() => import("@/pages/nidhi/loans"));
const NidhiEMIPage = lazy(() => import("@/pages/nidhi/emi"));
const NidhiSharesPage = lazy(() => import("@/pages/nidhi/shares"));
const NidhiGoldRatesPage = lazy(() => import("@/pages/nidhi/gold-rates"));
const NidhiInterestRatesPage = lazy(() => import("@/pages/nidhi/interest-rates"));
const NidhiDailyCollectionPage = lazy(() => import("@/pages/nidhi/daily-collection"));
const NidhiCompliancePage = lazy(() => import("@/pages/nidhi/compliance"));
const NidhiReportsPage = lazy(() => import("@/pages/nidhi/reports"));
const EcommerceDashboardPage = lazy(() => import("@/pages/ecommerce/dashboard"));
const EcommerceOrdersPage = lazy(() => import("@/pages/ecommerce/orders"));
const EcommerceListingsPage = lazy(() => import("@/pages/ecommerce/listings"));
const EcommerceShipmentsPage = lazy(() => import("@/pages/ecommerce/shipments"));
const EcommerceReturnsPage = lazy(() => import("@/pages/ecommerce/returns"));
const EcommerceSettlementsPage = lazy(() => import("@/pages/ecommerce/settlements"));
const EcommerceChannelsPage = lazy(() => import("@/pages/ecommerce/channels"));
const EcommerceReportsPage = lazy(() => import("@/pages/ecommerce/reports"));
const EcommerceWarehousesPage = lazy(() => import("@/pages/ecommerce/warehouses"));
const MastersHSNCodesPage = lazy(() => import("@/pages/masters/hsn-codes"));
const MastersSACCodesPage = lazy(() => import("@/pages/masters/sac-codes"));
const MastersTaxConfigPage = lazy(() => import("@/pages/masters/tax-config"));
const MastersStatesCountriesPage = lazy(() => import("@/pages/masters/states-countries"));
const MastersBankMasterPage = lazy(() => import("@/pages/masters/bank-master"));
const MastersBranchesPage = lazy(() => import("@/pages/masters/branches"));
const MastersDocNumberingPage = lazy(() => import("@/pages/masters/doc-numbering"));
const MastersEmailTemplatesPage = lazy(() => import("@/pages/masters/email-templates"));
const MastersSMSTemplatesPage = lazy(() => import("@/pages/masters/sms-templates"));
const MastersApprovalMatrixPage = lazy(() => import("@/pages/masters/approval-matrix"));
const MastersFeatureFlagsPage = lazy(() => import("@/pages/masters/feature-flags"));
const MastersPrintTemplatesPage = lazy(() => import("@/pages/masters/print-templates"));
const MastersWebhooksPage = lazy(() => import("@/pages/masters/webhooks"));
const IntegrationCredentialsPage = lazy(() => import("@/pages/masters/integration-credentials"));
const RestaurantFeedbackPublicPage = lazy(() => import("@/pages/restaurant-feedback-public"));
// Phase 7F — Nidhi
const NidhiLoanSanctionPage = lazy(() => import("@/pages/nidhi/loan-sanction"));
const NidhiPDCTrackingPage = lazy(() => import("@/pages/nidhi/pdc-tracking"));
const NidhiRBIReturnsPage = lazy(() => import("@/pages/nidhi/rbi-returns"));
// Phase 7G — CRM
const CRMLeadScoringPage = lazy(() => import("@/pages/crm/lead-scoring"));
const CRMDripCampaignsPage = lazy(() => import("@/pages/crm/drip-campaigns"));
const CRMCustomer360Page = lazy(() => import("@/pages/crm/customer-360"));
// Phase 7H — Logistics
const LogisticsEWayBillPage = lazy(() => import("@/pages/logistics/eway-bill"));
const LogisticsLiveGPSPage = lazy(() => import("@/pages/logistics/live-gps"));
const LogisticsRouteOptimizationPage = lazy(() => import("@/pages/logistics/route-optimization"));
// Phase 7I — Real Estate
const RealEstateRERAPage = lazy(() => import("@/pages/real-estate/rera"));
const RealEstateDemandLettersPage = lazy(() => import("@/pages/real-estate/demand-letters"));
const RealEstateProjectPLPage = lazy(() => import("@/pages/real-estate/project-pl"));
// Phase 7J — Agriculture ERP
const AgricultureMandiPricesPage = lazy(() => import("@/pages/agriculture/mandi-prices"));
const AgriculturePMFBYPage = lazy(() => import("@/pages/agriculture/pmfby"));
// Phase 7K — Education ERP
const EducationCertificatesPage = lazy(() => import("@/pages/education/certificates"));
const EducationNEPCompliancePage = lazy(() => import("@/pages/education/nep-compliance"));
// Phase 7L — Gold ERP
const GoldLiveRatesPage = lazy(() => import("@/pages/gold-erp/live-rates"));
const GoldHallmarkingPage = lazy(() => import("@/pages/gold-erp/hallmarking"));
const GoldSEBIReportingPage = lazy(() => import("@/pages/gold-erp/sebi-reporting"));
const GoldDigitalGoldPage = lazy(() => import("@/pages/gold-erp/digital-gold"));
// Phase 7M — HR ERP
const HREPFOFilingPage = lazy(() => import("@/pages/hr/epfo-filing"));
const HRComplianceCalendarPage = lazy(() => import("@/pages/hr/compliance-calendar"));
const HROfferLettersPage = lazy(() => import("@/pages/hr/offer-letters"));
const HRBiometricPage = lazy(() => import("@/pages/hr/biometric"));
// Phase 7N — Retail ERP
const RetailFranchisePage = lazy(() => import("@/pages/retail/franchise"));
const RetailB2BPortalPage = lazy(() => import("@/pages/retail/b2b-portal"));
const RetailStoreTransfersPage = lazy(() => import("@/pages/retail/store-transfers"));
const RetailLoyaltyPage = lazy(() => import("@/pages/retail/loyalty"));
const RetailOmniChannelPage = lazy(() => import("@/pages/retail/omni-channel"));
const RetailPOSHardwarePage = lazy(() => import("@/pages/retail/pos-hardware"));
// Phase 7O — Manufacturing ERP
const ManufacturingMRPPage = lazy(() => import("@/pages/manufacturing/mrp"));
const ManufacturingWorkOrdersPage = lazy(() => import("@/pages/manufacturing/work-orders"));
const ManufacturingAdvancedPage = lazy(() => import("@/pages/ManufacturingAdvancedPage"));
const ManufacturingQualityPage = lazy(() => import("@/pages/manufacturing/quality"));
const ManufacturingJobCardsPage = lazy(() => import("@/pages/manufacturing/job-cards"));
const ManufacturingSubContractingPage = lazy(() => import("@/pages/manufacturing/sub-contracting"));
const ManufacturingMachineOEEPage = lazy(() => import("@/pages/manufacturing/machine-oee"));
const ManufacturingBarcodeScannerPage = lazy(() => import("@/pages/manufacturing/barcode-scanner"));
const ManufacturingPreventiveMaintenancePage = lazy(() => import("@/pages/manufacturing/preventive-maintenance"));
const ManufacturingBomVersionsPage = lazy(() => import("@/pages/manufacturing/bom-versions"));
const ManufacturingSupplyChainPage = lazy(() => import("@/pages/manufacturing/supply-chain"));
import { parseISO } from "date-fns";
const NotificationEnginePage = lazy(() => import("@/pages/NotificationSettingsPage"));
// Phase 7P — Finance, HR, Admin (SwachERP phases 4-6)
const RecurringJournalsPage = lazy(() => import("@/pages/finance/recurring-journals"));
const GSTRFilingNewPage = lazy(() => import("@/pages/finance/gstr-filing-new"));
const ConsolidationPage = lazy(() => import("@/pages/finance/consolidation"));
const IFRSReportingPage = lazy(() => import("@/pages/finance/ifrs-reporting"));
const ZATCAPortalPage = lazy(() => import("@/pages/finance/zatca-portal"));
const InvestorPackPage = lazy(() => import("@/pages/finance/investor-pack"));
const StatutoryCalendarPage = lazy(() => import("@/pages/hr/statutory-calendar"));
const NotificationLogPage = lazy(() => import("@/pages/admin/notification-log"));
// SwachSign, SwachSocial, SwachMeet
const SwachSignIndex = lazy(() => import("@/pages/swachsign/index"));
const SwachSignDetail = lazy(() => import("@/pages/swachsign/detail"));
const SwachSignSignPage = lazy(() => import("@/pages/swachsign/sign-page"));
const SwachSignPlacement = lazy(() => import("@/pages/swachsign/placement"));
const SwachSocialIndex = lazy(() => import("@/pages/swachsocial/index"));
const SwachSocialComposer = lazy(() => import("@/pages/swachsocial/composer"));
const SwachSocialCalendar = lazy(() => import("@/pages/swachsocial/calendar"));
const SwachSocialAnalytics = lazy(() => import("@/pages/swachsocial/analytics"));
const SwachMeetIndex = lazy(() => import("@/pages/swachmeet/index"));
const SwachMeetRoom = lazy(() => import("@/pages/swachmeet/room"));
const SwachMeetRecordings = lazy(() => import("@/pages/swachmeet/recordings"));
const WebinarRegistration = lazy(() => import("@/pages/swachmeet/webinar-registration"));
// IFRS, ASC606, Investor, MRP, Analytics pages
const IfrsConsolidationPage = lazy(() => import("@/pages/ifrs/consolidation-dashboard"));
const Asc606ArrangementsPage = lazy(() => import("@/pages/asc606/arrangements"));
const InvestorDashboardPage = lazy(() => import("@/pages/investor/dashboard"));
const CapTablePage = lazy(() => import("@/pages/investor/cap-table"));
const BomManagerPage = lazy(() => import("@/pages/mrp/bom-manager"));
const MrpRunPage = lazy(() => import("@/pages/mrp/mrp-run"));
const AnalyticsStudioPage = lazy(() => import("@/pages/analytics/studio"));
const DashboardBuilderPage = lazy(() => import("@/pages/analytics/dashboard-builder"));
// Phase 7Q — New vertical pages
const HotelBanquetEventsPage = lazy(() => import("@/pages/hotel/banquet-events"));
const HealthcareEMRVisitPage = lazy(() => import("@/pages/healthcare/emr-visit"));
const NidhiMemberPassbookPage = lazy(() => import("@/pages/nidhi/member-passbook"));
const NidhiMobileCollectionPage = lazy(() => import("@/pages/nidhi/mobile-collection"));
const NGODonorAdminPage = lazy(() => import("@/pages/ngo/donor-admin"));
// Phase 7R — SwachERP new vertical pages
const GpsTrackingPage = lazy(() => import("@/pages/logistics/gps-tracking"));
const ReraCompliancePage = lazy(() => import("@/pages/real-estate/rera-compliance"));
const FefoBillingPage = lazy(() => import("@/pages/pharmacy/fefo-billing"));
