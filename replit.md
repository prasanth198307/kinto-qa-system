...
- **Core ERP Modules:** Production, inventory, purchase orders, sales orders, GST-compliant invoicing, gatepasses, quality/returns, accounting (COA, ledger, P&L, Balance Sheet), preventive maintenance, expenses, cash register, and document management.
